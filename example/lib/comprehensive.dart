...
class _NavigatorTargetPage extends StatefulWidget {
  const _NavigatorTargetPage({required this.useBrowserScroller});

  final bool useBrowserScroller;

  @override
  State<_NavigatorTargetPage> createState() => _NavigatorTargetPageState();
}

class _NavigatorTargetPageState extends State<_NavigatorTargetPage> {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.useBrowserScroller
              ? 'Pushed: BrowserScroller'
              : 'Pushed: plain Scrollable',
        ),
        backgroundColor: Theme.of(context).colorScheme.inversePrimary,
      ),
      floatingActionButton: _ScrollFabColumn(
      ...
      body: _TestPageBody(
        ...
        intro: Padding(
          ...
          child: Text(
            widget.useBrowserScroller
                ? 'This pushed route wraps its list in BrowserScroller. '
                      'With the topmost-route-wins fix, Navigator.push and '
                      'pushReplacement both hand the browser-scroll slot to '
                      'this page. Scroll with wheel, trackpad, keyboard '
                      '(PageDown, arrows), or the floating buttons, and pop '
                      'back to verify the previous route reclaims. The body '
                      'below mirrors the home page so you can exercise every '
                      'test case again from here.'
                : 'Control page: plain Scrollable, no BrowserScroller. '
                      'Flutter handles scroll in Dart. The previous route '
                      'retains the browser-scroll slot. The body below '
                      'mirrors the home page so you can compare Dart-driven '
                      'scroll behavior against browser-driven scroll by '
                      'popping back.',
            style: const TextStyle(
              fontSize: 15,
              height: 1.6,
